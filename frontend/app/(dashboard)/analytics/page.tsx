  ...
  return (
    <div className="min-h-screen bg-ink text-text-primary p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-text-muted">
                7-day moving window of parking infractions detected
              </p>
            </div>
            <span className="text-[11px] font-mono text-brand flex items-center gap-1">
              <TrendingUp className="h-3.5 w-3.5" />
              Peak: 19 Aug (18 Violations)
            </span>
          </div>

          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={DAILY_DATA} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
        ...
        {/* Vehicle Classification Breakdown (1 col) */}
        <div className="rounded-xl border border-border bg-surface p-5 shadow-card space-y-4">
          <div>
            ...
            <p className="text-xs text-text-muted">
              Composition of detected vehicles in enforcement zones
            </p>
          </div>
      ...
      <div className="rounded-xl border border-border bg-surface p-5 shadow-card space-y-4">
        <div>
          <h3 className="text-sm font-semibold text-text-primary">
            Violations & Revenue by Municipal Zone
          </h3>
          <p className="text-xs text-text-muted">
            Comparison of active enforcement zones across the city
          </p>
        </div>

        <div className="h-56 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={ZONE_DATA} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.05)" />
